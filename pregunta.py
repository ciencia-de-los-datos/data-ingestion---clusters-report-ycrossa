...
def ingest_data():
    # Lectura de la tabla, definiendo nombres de columnas
    ...
    #Definicion del tipo de cada columna
    df = df.astype  ({ "cluster": int, "cantidad_de_palabras_clave": int,  "porcentaje_de_palabras_clave": float, "principales_palabras_clave": str
                    })
    #print(df)
    # agrupacion por iguales datos,uniendo las palabras
...
def test_01():
    ...
    assert ingest_data().cluster.to_list() == list(range(1, 14))


def test_02():
    #print(ingest_data().cantidad_de_palabras_clave.to_list())
    assert ingest_data().cantidad_de_palabras_clave.to_list() == [
        105,
        102,
        89,
        60,
...
def test_03():
    ...
    assert ingest_data().porcentaje_de_palabras_clave.to_list() == [
        15.9,
        15.4,
        13.4,
        9.1,
...
def test_04():
    ...
    #print(ingest_data().principales_palabras_clave.to_list()[2])
    #print(ingest_data().principales_palabras_clave.to_list()[3])
    #print(ingest_data().principales_palabras_clave.to_list()[4])
    #print(ingest_data().principales_palabras_clave.to_list()[5])
    #print(ingest_data().principales_palabras_clave.to_list()[6])
    #print(ingest_data().principales_palabras_clave.to_list()[7])
    #print(ingest_data().principales_palabras_clave.to_list()[8])
    #print(ingest_data().principales_palabras_clave.to_list()[9])
    #print(ingest_data().principales_palabras_clave.to_list()[10])
